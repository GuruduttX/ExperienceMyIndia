...
export default function OfferBanner() {
    ...
    const Box = ({ value, label }: { value: number; label: string }) => (
      <div className="flex flex-col items-center flex-1 md:flex-none">
        <div
          className="w-full md:w-14 h-14 bg-[#1a1a1a] border border-white/10 rounded-lg 
    ...
    return (
      <section className="px-6 py-10 bg-white">
        <div className="max-w-7xl mx-auto">
          {/* MAIN CONTAINER */}
          <div
            className="relative rounded-2xl p-6 md:p-10 flex flex-col md:flex-row 
          ...
          >
            ...
            <div className="relative z-10 max-w-xl text-white">
                <div className="flex flex-col gap-4 md:gap-2">
                    <h2 className="text-xl md:text-3xl font-semibold leading-snug">
                        Up to <span className="font-bold">₹1,11,540 OFF</span> on
                        selected trips
                    </h2>
                        <span className=" px-3 py-1 w-fit text-xs bg-yellow-400 text-black rounded-full font-semibold whitespace-nowrap">
                        SUMMER HOLIDAY SALE!
                        </span>
              ...
              text-black font-semibold rounded-lg shadow-lg hover:scale-105 transition w-full md:w-auto"
              >
            ...
            <div className="relative z-10 flex flex-col items-center">
              <p className="text-white mb-3 text-sm">Hurry – Offer ends in!</p>
